...
{
    protected static final int DISPLAY_LIST_CACHE_SIZE = 200;
    protected static final int MAX_GLYPH_CODE = 1114111;
    protected static final int PAGE_SIZE = 512;
    protected static final int PAGES = 2175;
    protected static final SGL GL;
    protected static final DisplayList EMPTY_DISPLAY_LIST;
    ...
    protected final List glyphPages;
    protected final List queuedGlyphs;
    ...
    protected boolean displayListCaching;
    protected int baseDisplayListID;
    protected int eldestDisplayListID;
    protected DisplayList eldestDisplayList;
    protected final LinkedHashMap displayLists;
    ...
    protected Glyph getGlyph(final int glyphCode, final int codePoint, final Rectangle bounds, final GlyphVector vector, final int index) {
    ...
    protected Rectangle getGlyphBounds(final GlyphVector vector, final int index, final int codePoint) {
